...
export type PermissionPolicy = { permission: string; target?: 'global' | 'company' | 'property' | 'body-company' | 'body-project' | 'body-property' | 'api-client' | 'project' | 'relationship' | 'reservation' | 'integration' | 'service'; list?: ListResource };
